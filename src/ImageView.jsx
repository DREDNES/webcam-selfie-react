...
export default function ImageView(props) {
  ...
  <div>
    ...
    <div className='actionsImageView'>
      <input alt='' type="image" style={{ backgroundColor: "#6fff36"}} onClick = {()=>download()} src={Save} />
      <input alt='' type="image" style={{ backgroundColor: "#ff5c36"}} onClick = {()=>props.delete()} src={Delete} />
    </div>
  </div>
  );
};